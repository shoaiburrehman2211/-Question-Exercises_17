...
*/
var myFriends = ["Zohaib", "Ayaz", "Faisal", "Rameez", "Junaid", "Ahmed"];
...
console.log("sorry Mr. ".concat(friends3, " you are not invited!"));
var friends4 = myFriends.pop();
console.log("sorry Mr. ".concat(friends4, " you are not invited!"));
